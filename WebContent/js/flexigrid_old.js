...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
			 ...
			 rpOptions: [10,20,40,60,80],
			 title: false,
			 pagestat: 'Mostrando {from} - {to} de {total} registros',
			 procmsg: 'Precessando, aguarde ...',
			 query: '',
			 qtype: '',
					 ...
					 function(i,row) 
					 	{
							...
							if (i % 2 && p.striped) { 
								tr.className = 'erow ui-widget-content';
							} 
				 	...
				 	function ()
						{
							...
							var tr = document.createElement('tr');
							if (i % 2 && p.striped) tr.className = 'erow ui-widget-content';
		...
		//set hDiv
		g.hDiv.className = 'hDiv ui-widget ui-widget-content ui-helper-clearfix';
		...
		//add strip		
		if (p.striped) 
			$('tbody tr:odd',g.bDiv).addClass('erow ui-widget-content');
			
			
		if (p.resizable && p.height !='auto') 
		{
		g.vDiv.className = 'vGrip  ui-dialog-titlebar ui-widget-header ui-helper-clearfix';
		$(g.vDiv)
		...
		$(g.bDiv).after(g.pDiv);
		var html = ' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">Pag. <input type="text" size="4" value="1" /> de <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><span></span></div><div class="pLast pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
		...
		if (p.searchitems)
			{
				//add search box
				g.sDiv.className = 'sDiv ui-dialog-titlebar ui-widget-header ui-helper-clearfix';
				...
				$(g.sDiv).append("<div class='sDiv2'>Pesquisar <input type='text' size='30' name='q' class='qsbox' /> <select name='qtype'>"+sopt+"</select> <input type='button' value='Limpar' class='ui-state-default ui-corner-all' /></div>");
		...
		if (p.title)
		{
			g.mDiv.className = 'mDiv ui-dialog-titlebar ui-widget-header ui-helper-clearfix';
